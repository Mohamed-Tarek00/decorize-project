...
import 'package:decorize_project/features/worker/more/presentation/view/widgets/otp_code_text_field.dart';
...
class WorkerPhoneOtpViewBody extends StatelessWidget {
  const WorkerPhoneOtpViewBody({super.key});
          ...
          child: CustomWorkerButton(
            onTap: () {
              CustomBottomSheet.show(
                ...
                mainText: 'تم تغيير رقم الهاتف بنجاح بنجاح',
                bodyText:
                    'تم تغيير رقم الهاتف الخاص بك بنجاح يمكنك الان استخدام هذا الرقم',
              );
            },
            height: 40.h,
